...
export class MsgClientImpl implements Msg {
  ...
  AggregateExchangeRatePrevote(
    ...
    const promise = this.rpc.request("merlion.oracle.v1.Msg", "AggregateExchangeRatePrevote", data);
  ...
  AggregateExchangeRateVote(
    ...
    const promise = this.rpc.request("merlion.oracle.v1.Msg", "AggregateExchangeRateVote", data);
  ...
  DelegateFeedConsent(request: MsgDelegateFeedConsent): Promise<MsgDelegateFeedConsentResponse> {
    ...
    const promise = this.rpc.request("merlion.oracle.v1.Msg", "DelegateFeedConsent", data);
